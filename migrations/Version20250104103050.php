 ...
 */
final class Version20250104103050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER user_name SET NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER user_name DROP NOT NULL');
    }
}
